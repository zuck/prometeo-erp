...
urlpatterns = patterns('partners.views',
    ...
    #url(r'^partners/(?P<partner_id>\d+)/contacts/(?P<id>\d+)/edit/$', view='partners.partner_edit_contact', name='partner_edit_contact'),
    #url(r'^partners/(?P<partner_id>\d+)/contacts/(?P<id>\d+)/delete/$', view='partners.partner_delete_contact', name='partner_delete_contact'),
    ...
    url(r'^partners/contacts/(?P<contact_id>\d+)/addresses/(?P<id>\d+)/edit/$', view='contacts.contact_edit_address', name='contact_edit_address'),
    url(r'^partners/contacts/(?P<contact_id>\d+)/addresses/(?P<id>\d+)/delete/$', view='contacts.contact_delete_address', name='contact_delete_address'),
    ...
    url(r'^partners/contacts/(?P<contact_id>\d+)/phones/(?P<id>\d+)/edit/$', view='contacts.contact_edit_phone', name='contact_edit_phone'),
    url(r'^partners/contacts/(?P<contact_id>\d+)/phones/(?P<id>\d+)/delete/$', view='contacts.contact_delete_phone', name='contact_delete_phone'),
