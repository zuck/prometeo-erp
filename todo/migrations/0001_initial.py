...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_table('todo_task_categories')

        # Removing M2M table for field tags on 'Task'
        db.delete_table('todo_task_tags')
