...
urlpatterns = patterns('stock.views',
    ...
    # Delivery notes.
    url(r'^delivery-notes/$', view='deliverynotes.deliverynote_list', name='deliverynote_list'),
    url(r'^delivery-notes/add$', view='deliverynotes.deliverynote_add', name='deliverynote_add'),
    url(r'^delivery-notes/(?P<id>\d+)/$', view='deliverynotes.deliverynote_detail', name='deliverynote_detail'),
    url(r'^delivery-notes/(?P<id>\d+)/edit/$', view='deliverynotes.deliverynote_edit', name='deliverynote_edit'),
